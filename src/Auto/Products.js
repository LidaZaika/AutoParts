    ...
    return (
      ...
      <div class="backround">
		<div class="ST-all">
			...
			<div class="ST"> 
				<div class="STblock" >
					<div class="STcatalog text">
						<a href="/Catalog"><h6>Автохимия</h6></a><br/>
					<a>Масла</a> <br/>
					<a>Смазки</a> <br/>
					<a>Ароматизаторы</a>
					</div>
					<div class="STcatalog foto"><img height="60%" width="60%" alt=""
				...
				<div>
					<div class="text STcatalog">
						<a href="/Catalog"><h6>Диски</h6></a><br/>
					<a>Литые</a><br/>
					<a>Штампованые </a><br/>
					</div>
					<div class="foto STcatalog"><img height="70%" width="70%" alt=""
				...
				<div>
					...
					<div class="foto STcatalog"><img height="60%" width="60%" alt=""
				...
				<div>
					...
					<div class="foto STcatalog"><img height="100%" width="100%" alt=""
